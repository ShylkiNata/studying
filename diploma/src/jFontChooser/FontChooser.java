...
public class FontChooser {
    ...
    private int createFontLabelControl(int gridy) {
        ...
        addComponent(mainPanel, fontNameLabel, 0, gridy, 1, 1, LABEL_INSETS,
                GridBagConstraints.LINE_START, GridBagConstraints.NONE);
 
        JLabel fontStyleLabel = new JLabel("Font style");
        addComponent(mainPanel, fontStyleLabel, 1, gridy, 1, 1, LABEL_INSETS,
                GridBagConstraints.LINE_START, GridBagConstraints.NONE);
 
        JLabel fontSizeLabel = new JLabel("Size");
        addComponent(mainPanel, fontSizeLabel, 2, gridy++, 1, 1, LABEL_INSETS,
                GridBagConstraints.LINE_START, GridBagConstraints.NONE);
    ...
    private int createFontComboBoxControl(int gridy) {
        ...
        addComponent(mainPanel, fontNameList, 0, gridy, 1, 1, COMBOBOX_INSETS,
        ...
        addComponent(mainPanel, fontStyleList, 1, gridy, 1, 1, COMBOBOX_INSETS,
                GridBagConstraints.LINE_START, GridBagConstraints.HORIZONTAL);
        ...
        addComponent(mainPanel, fontSizeList, 2, gridy++, 1, 1,
    ...
    private int createSampleControl(int gridy) {
        ...
        addComponent(mainPanel, titlePanel, 0, gridy++, 3, 1,
                COMBOBOX_INSETS_LAST, GridBagConstraints.LINE_START,
                GridBagConstraints.HORIZONTAL);
    ...
    private int createButtonControl(int gridy) {
        ...
        addComponent(mainPanel, buttondrawingPanel, 0, gridy++, 3, 1,
